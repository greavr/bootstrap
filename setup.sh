...
sudo DEBIAN_FRONTEND=noninteractive apt-get install -y cmatrix git-all wget curl htop nano gpg zsh cowsay fortune sl telnet tcpdump wireshark dnsutils apt-utils apache2-utils
